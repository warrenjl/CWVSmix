...
For $1{:}1$ matched case-control data, let $k=1,...,K$ index matched pairs, with $\textbf{x}_{ki}$ and $\textbf{z}_{ki}$ denoting the covariate vectors for subject $i \in \{0,1\}$ (control, case) within pair $k$. The conditional likelihood, obtained by conditioning on the event that exactly one member of each pair is a case, is given as:
