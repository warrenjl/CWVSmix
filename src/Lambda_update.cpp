...
/*Second*/
second = -0.50*dot((gamma - off_set - x*beta - risk_sum_old*eta_full), w%(gamma - off_set - x*beta - risk_sum_old*eta_full)) +
...
first = -0.50*dot((gamma - off_set - x*beta - risk_sum*eta_full), w%(gamma - off_set - x*beta - risk_sum*eta_full)) + 
