...
// lambda_update
Rcpp::List lambda_update(arma::mat lambda_star, arma::mat lambda_old, int ind, int p, int m, arma::mat x, arma::mat z, arma::vec w, arma::vec gamma, arma::vec beta, arma::vec eta_full, arma::mat risk_sum, arma::mat temporal_corr_inv_old, double metrop_var_lambda_trans, int acctot_lambda);
RcppExport SEXP _CWVSmix_lambda_update(SEXP lambda_starSEXP, SEXP lambda_oldSEXP, SEXP indSEXP, SEXP pSEXP, SEXP mSEXP, SEXP xSEXP, SEXP zSEXP, SEXP wSEXP, SEXP gammaSEXP, SEXP betaSEXP, SEXP eta_fullSEXP, SEXP risk_sumSEXP, SEXP temporal_corr_inv_oldSEXP, SEXP metrop_var_lambda_transSEXP, SEXP acctot_lambdaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(lambda_update(lambda_star, lambda_old, ind, p, m, x, z, w, gamma, beta, eta_full, risk_sum, temporal_corr_inv_old, metrop_var_lambda_trans, acctot_lambda));
    return rcpp_result_gen;
END_RCPP
}
